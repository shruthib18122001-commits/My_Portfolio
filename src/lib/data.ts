...
export const projects = [
  ...
  },
  {
    ...
    tech: ["React Native", "Node.js", "TypeScript", "PostgreSQL", "Prisma", "Gemini AI"],
    gradientFrom: "#1e1b4b",
    gradientTo: "#312e81",
    accentColor: "#818cf8",
    icon: "🏃",
    bullets: [
      "Built a full-stack mobile app with a scalable Node.js backend and React Native/Expo frontend across 10+ screens supporting 500+ daily active users; integrated Prisma ORM with PostgreSQL for real-time habit tracking, social tribe functionality, and multi-step onboarding flows.",
      "Integrated Gemini AI API delivering personalized coaching overlays across 5+ habit types; reduced feature development time by 30% by applying Generative AI to automate content generation and user nudge logic.",
      "Optimized API performance through query indexing and Redis caching, achieving 35% faster response times; containerized all services with Docker, reducing deployment setup time from 2 hours to under 10 minutes.",
    ],
  },
  {
    title: "RateGuard",
